...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>';
		...
		echo '<style type="text/css">
			...
			html body main iframe { width: 100%; height: 100%; }
		</style>
		<script type="text/javascript">
			$(document).ready(function() {
				$("html body").css("--h", $(document).height().toString()+"px");
			});
		</script>
	</head>
	<body class="nohbar">';
		echo '<main>
			<iframe src="/reg/teacher/admission-upload/'.$path.'">Loading...</iframe>
		</main>';
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>';
		...
		<script type="text/javascript">
			...
			}; var prevkey = [], rh = function() { $("html body").css("--h", $(document).height().toString()+"px"); }
			$(document).ready(function() {
				...
				setTimeout(function() {
					...
					setTimeout(function() { $("html body main div.container div.wrapper div img").remove(); rh(); }, 250);
					rh();
				}, 250);
